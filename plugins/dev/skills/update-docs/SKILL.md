---
name: update-docs
description: Sync documentation with the codebase by generating from source-of-truth files (package.json, .env.example, openapi.yaml). Updates CONTRIBUTING.md, RUNBOOK.md, and flags docs stale for 90+ days.
---

...
description: Scan the codebase and generate token-lean architecture documentation in docs/CODEMAPS/ covering routes, services, data models, and dependencies. Use after major features or refactoring sessions.
---
# Update Codemaps

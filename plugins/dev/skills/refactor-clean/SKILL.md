---
name: refactor-clean
description: Safely identify and remove dead code using analysis tools (knip, depcheck, ts-prune, vulture), with test verification after each deletion. Use when cleaning up unused exports, files, or dependencies.
---
# Refactor Clean

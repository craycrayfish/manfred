---
name: test-coverage
description: Analyze test coverage, identify uncovered code paths, and generate missing tests to reach 80%+ coverage. Supports Jest, Vitest, pytest, Go, Rust, and Java projects.
---
# Test Coverage
